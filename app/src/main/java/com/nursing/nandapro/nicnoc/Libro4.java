...
public class Libro4 extends AppCompatActivity {
    ...
    public void init2(){
        ...
        DatabaseHelper myDbHelper = new DatabaseHelper(Libro4.this, MainActivity.namedb5);
        try {
        ...
        ListAdapter listAdapter = new ListAdapter(elements, this, new ListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(ListElement item) {
                ...
                Intent mIntent  = new Intent(com.nursing.nandapro.nicnoc.Libro4.this, Libro4clases.class);
    ...
    */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.valorar) {
            Intent mIntent  = new Intent(Libro4.this, Favoritos.class);
        ...
        if (id == R.id.action_search) {
            Intent mIntent = new Intent(Libro4.this, DiagnosticosBusqueda.class);
            mIntent.putExtra("Base", "Libro4");
            startActivity(mIntent);
        }
    ...
    public void info(){
        AlertDialog.Builder a = new AlertDialog.Builder(Libro4.this);
    ...
    public void calificar(){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Libro4.this);
