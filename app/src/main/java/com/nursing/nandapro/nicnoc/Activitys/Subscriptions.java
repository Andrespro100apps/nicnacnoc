...
import com.nursing.nandapro.nicnoc.interfaces.adapters.SubscriptionAdapter;
//import com.nursing.nandapro.nicnoc.RecycleViewInterface;
...
*/
    ...
    void showProducts() {
        ...
        ImmutableList<QueryProductDetailsParams.Product> productList = ImmutableList.of(
                ...
                //Product 2
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId("tresmeses")
                        .setProductType(BillingClient.ProductType.SUBS)
                        .build(),

                //Product 2
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId("seismeses")
                        .setProductType(BillingClient.ProductType.SUBS)
                        .build(),

                //Product 2
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId("oneyear")
                        .setProductType(BillingClient.ProductType.SUBS)
                        .build()
