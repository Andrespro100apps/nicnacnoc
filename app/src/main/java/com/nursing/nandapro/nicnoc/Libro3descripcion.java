...
public class Libro3descripcion extends AppCompatActivity {
...
*/
    ...
    private void ComprobarIdiomaTitulos() {
        switch (MainActivity.namedb3){
            case "db_3esp.db":
                ...
                tvCaracteristicasT.setText(" Actividades");
            ...
            case "db_3pt.db":
                ...
                tvCaracteristicasT.setText(" Atividades");
                tvFactoresT.setText(" Puntuación diana");
                tvPoblacionT.setText(" Puntuación global de resultado");
                tvCondicionesT.setText(" Puntuación diana ");
                break;
            ...
            case "db_3fr.db":
                ...
                tvCaracteristicasT.setText(" Activités");
                tvFactoresT.setText(" score cible");
                tvPoblacionT.setText(" Note globale du résultat");
                tvCondicionesT.setText(" score cible ");
                break;
            case "db_3de.db":
                tvDefinicionT.setText(" Definition");
                tvCaracteristicasT.setText(" Aktivitäten");
                tvFactoresT.setText(" Zielpunktzahl");
                tvPoblacionT.setText(" Gesamtnote des Ergebnisses");
                tvCondicionesT.setText(" Zielpunktzahl ");
                break;
            case "db_3it.db":
                tvDefinicionT.setText(" Definizione");
                tvCaracteristicasT.setText(" Attività");
            ...
            case "db_3id.db":
                ...
                tvCaracteristicasT.setText(" Kegiatan");
                tvFactoresT.setText(" skor sasaran");
                tvPoblacionT.setText(" Skor hasil keseluruhan");
                tvCondicionesT.setText(" skor sasaran ");
                break;
            case "db_3ko.db":
                tvDefinicionT.setText(" 정의");
                tvCaracteristicasT.setText(" 활동");
    ...
    public void init(){
        ...
        DatabaseHelper myDbHelper = new DatabaseHelper(com.nursing.nandapro.nicnoc.Libro3descripcion.this, MainActivity.namedb3);
        try {
