...
public class Cie10clases extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (interstitial != null) {
            interstitial.show(Cie10clases.this);
        } else {
    ...
    public void init(){
        ...
        DatabaseHelper myDbHelper = new DatabaseHelper(Cie10clases.this, MainActivity.namedb4);
        try {
        ...
        ListAdapter listAdapter = new ListAdapter(elements, this, new ListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(ListElement item) {
                Toast.makeText(Cie10clases.this, "Proximamente ;)", Toast.LENGTH_SHORT).show();

                String nClase = item.getDominio();
                Intent mIntent  = new Intent(Cie10clases.this, Libro2diagnostico.class);
    ...
    public void info(){
        AlertDialog.Builder a = new AlertDialog.Builder(com.nursing.nandapro.nicnoc.Cie10clases.this);
    ...
    public void calificar(){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(com.nursing.nandapro.nicnoc.Cie10clases.this);
